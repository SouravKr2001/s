...
public class GroceryItemActivity extends AppCompatActivity implements AddReviewDialog.AddReview {
    ...
    public static final String TAG = "GroceryItemActivity";
    ...
    private ImageView firstEmptyStar,firstFilledStar,secondEmptyStar,secondFilledStar,thirdEmptyStar,thirdFilledStar;
